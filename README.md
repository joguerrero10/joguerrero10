<h1 align="center">👋 Joel Guerrero</h1>
 
<p align="center">
  <strong>Cloud Governance Specialist · Senior Developer · DevOps Engineer</strong><br/>
  <em>Infraestructura multi-cloud · Arquitecturas limpias · Seguridad y automatización</em>
</p>
<p align="center">
...
const joel: SeniorEngineer = {
  role:        "Cloud Governance Specialist & Senior Developer",
  experience:  "5+ años en Cloud, DevOps & Full Stack",
  clouds:      ["AWS", "Azure", "OCI"],
  iac:         ["Terraform", "Docker", "Kubernetes"],
  languages:   ["Java", "Python", "JavaScript", "TypeScript", "PHP"],
  cicd:        ["Azure DevOps", "GitHub Actions", "Pipelines CI/CD"],
  currentFocus: "Multi-cloud governance + Clean Architecture + DDD",
  mindset:     "Automatizar todo, documentar siempre, mejorar cada día",
};
```
...
![Ethical Hacking](https://img.shields.io/badge/Ethical%20Hacking-Deloitte%20%7C%20ITSE-red?style=for-the-badge)
![SOC](https://img.shields.io/badge/SOC%20Analyst-Nivel%201-blue?style=for-the-badge)
![MITRE](https://img.shields.io/badge/MITRE%20ATT%26CK-Framework-orange?style=for-the-badge)
![Cloud Security](https://img.shields.io/badge/Cloud%20Security-IAM%20%7C%20Firewall%20%7C%20Compliance-green?style=for-the-badge)
...
```
Cloud Governance     ████████████████████  Experto
DevOps / CI-CD       ███████████████████░  Experto
Infraestructura IaC  ██████████████████░░  Avanzado
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=tu-usuario-github&color=58a6ff&style=flat-square" alt="Profile views"/>
</p>
